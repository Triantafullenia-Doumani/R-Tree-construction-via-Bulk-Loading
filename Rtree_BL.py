...
# read the offsets out of an input file
def read_offsets():
...
# read the coords of each object and return the MBR( minimum bounding rectangle)
...
# Level n of Rtree – NODES (n > 0). Generate each level of Rtree with recursion
...
#  calculate the MBR( minimum bounding rectangle) of the child objects of a specific node of the Rtree
